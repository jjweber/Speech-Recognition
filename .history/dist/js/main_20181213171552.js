...
let localWeatherUrl = 'https://cors.io/?https://api.openweathermap.org/data/2.5/weather?q=London'
...
recognition.onresult = (event) => {
    ...
    if(command.toLowerCase().includes('weather')) {
        responsiveVoice.speak('Hold on. Checking the local weather ' + searchTerms[1] + '!');
        setTimeout(function () {
            console.log(searchTerms[1]);
            this.goWiki(searchTerms[1]);
        }, 3000);
