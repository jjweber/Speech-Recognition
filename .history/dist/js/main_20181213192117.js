...
function speakTheWeather(data) {
    ...
    responsiveVoice.speak('Today is' + weatherData.weather[0].description + ' and ' + weatherData.main.temp +  ' degrees.' + 'The high will be ' + weatherData.main.temp_max + 'degrees. And the low will be ' + weatherData.main.temp_min + ' degrees.' );
}
