...
let localWeatherUrl = 'https://cors.io/?https://api.openweathermap.org/data/2.5/weather?id=4467732&units=fahrenheit&appid=eb065997c35167132aa6797ba588b228'
...
function speakTheWeather(data) {
    ...
    let currentTemp = (weatherData.wind.deg * 9) / 5 + 32;
    let highTemp = (weatherData.main.temp_max * 9) / 5 + 32;
    let lowTemp = (weatherData.main.temp_min * 9) / 5 + 32;
