...
function speakTheWeather(data) {
    ...
    responsiveVoice.speak('Today is' + description + ' and ' + currentTemp +  ' degrees.' + 'The high will be ' + weatherData.main.temp_max + 'degrees. And the low will be ' + weatherData.main.temp_min + ' degrees.' );
}
